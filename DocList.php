                ...
                <div class="row no-gutters">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            $avg = "SELECT FORMAT(AVG(DISTINCT rating), 0) AS average FROM doctor_feedback where d_id = ".$d_id;
                        ...
                        <a class="btn btn-outline-primary" href="doctor_Req.php?d_id=<?php echo $d_id; ?>" role="button">Hire</a>
