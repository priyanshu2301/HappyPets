...
<body>
  ...
  <h2 class="mx-5 mt-3">Register as seller</h2>
      ...
      <div class="mt-5">
        <div class="form-row mx-5">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="shop_name" required name="shop_name">
          </div>
        ...
        <div class="form-row mx-5">
          ...
          <div class="container mt-4 mr-5 m-md-4">
            <button type="submit" class="btn btn-outline-success" id="submit" name="submit"
