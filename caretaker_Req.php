...
<?php
    ...
    if (isset($_POST["submit"]) == "submit"){
        $query = dbInsert('caretaker_client_req', [
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="CaretakerList.php">Back</a>
...
<div class="form-row mx-5">
    ...
    <div class="form-group col-md-6">
        <label for="time_peroid">Select the time peroid</label>
        <select class="form-select" id="time_period" name="time_period" id="time_period">
            <option value="Hours" name="time_period" id="option_1">Hours</option>
            <option value="Days" name="time_period" id="option_2">Days</option>
            <option value="Weeks" name="time_period" id="option_3">Weeks</option>
        </select>
    </div>
